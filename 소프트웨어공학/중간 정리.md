...
## 요구사항 분석을 위한 시스템 모델링
1. Data Modeling: Class에 들어갈 data object를 정의하고, 속성, 관계를 정의한다. E-R Modeling 이나 Class Diagram이 있다

2. Functional Modeling: 함수의 Input으로 어떤 Data Object가 들어갈지 판단. Data flow를 나타낸다. Data-Flow Diagram이 있다

3. Behavior Modeling: State가 어떻게 변하는지를 나타낸다. 상태를 변화시키는 이벤트를 구체화한다. State-Diagram이 있다
